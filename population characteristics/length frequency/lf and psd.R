...
setwd("C:/Users/Ben.Neely/OneDrive - State of Kansas, OITS/Desktop/BCF pop character paper/pop characters")
...
eldr_plot=ggplot(eldr1)+
  ...
  geom_vline(xintercept=c(300,510,760,890),linetype="dashed",
             color="black",alpha=0.5)+
  annotate("text",x=1220,y=0.06,hjust=1,vjust=1,label="El Dorado",size=8)+
  annotate("text",x=1220,y=0.049,hjust=1,vjust=1,
           label="N = 1137\nPSD-Q = 42",size=4)+
  pubtheme+
...
tcrr_plot=ggplot(tcrr1)+
  ...
  scale_x_continuous(limits=c(0,1250),
                     ...
                     expand=c(0,0),
                     name="")+
  scale_y_continuous(limits=c(0,0.101),
                     breaks=seq(0,0.10,0.02),
                     expand=c(0,0),
                     name="")+
  geom_vline(xintercept=c(300,510,760,890),linetype="dashed",
             color="black",alpha=0.5)+
  annotate("text",x=1220,y=0.1,hjust=1,vjust=1,label="Tuttle Creek",size=8)+
  annotate("text",x=1220,y=0.082,hjust=1,vjust=1,
           label="N = 750\nPSD-Q = 57\nPSD-P = 7\nPSD-M = 1",size=4)+
  pubtheme
...
wlfc_plot=ggplot(wlfc1)+
  ...
  geom_vline(xintercept=c(300,510,760,890),linetype="dashed",
             color="black",alpha=0.5)+
  annotate("text",x=1220,y=0.08,hjust=1,vjust=1,label="Wolf Creek",size=8)+
  annotate("text",x=1220,y=0.066,hjust=1,vjust=1,
           label="N = 572\nPSD-Q = 32\nPSD-P = 9\nPSD-M = 2",size=4)+
  pubtheme
